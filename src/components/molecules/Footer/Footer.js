      ...
      <footer className="bg-primary text-white">
        <div className="container py-5">
          <div className="row">
            ...
            <div className="col-4" />
            <div className="col-4">
              <h5 className={style.footerNavTitle}>このサイトについて</h5>
              <p className={style.footerNavText}>
